...
try {
  ...
  for (const id of ["vooya-compiler", "vooya-core", "vooya-build-core", "vooya-vite-plugin", "vooya-vue", "vooya-react", "vooya-webpack"]) {
  ...
  for (const directory of ["compiler", "core", "build-core", "vite-plugin", "vue", "react", "webpack"]) {
