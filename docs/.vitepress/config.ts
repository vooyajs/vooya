    ...
    nav: [
      {
        ...
        items: [
          ...
          { text: "Astro client islands", link: "/guide/astro" },
          { text: "Math Plot template", link: "/guide/math-plot" },
      ...
      "/rfcs/": [
        {
          ...
          items: [
            ...
            { text: "In-place component updates", link: "/rfcs/0010-in-place-component-updates" },
